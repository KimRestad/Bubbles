...
namespace Bubbles
{
    class CreditsScreen : OverlayScreen
    {
        ...
        public CreditsScreen()
            : base(new Point(600, 700), new Rectangle(0, 0, Core.ClientBounds.Width, Core.ClientBounds.Height), Color.White, 0.9f)
        {
            ...
            mFrameVerPos2 = new Rectangle(mPosition.X + mPosition.Width - width, mPosition.Y + width, width, mPosition.Height - width * 2);
            ...
            mLines.Add(new TextLine("Credits", Color.Yellow, new Vector2(textX, mPosition.Y + mPosition.Height - width - 16), 1.5f));
            ...
            mBtnClose = new Button(BtnCloseClick, new Rectangle(midScreenX - 128, mPosition.Y + mPosition.Height - height, 256, height), "Close");
        ...
        public override void Draw(SpriteBatch spritebatch)
        {
            ...
            foreach (TextLine tl in mLines)
            {
                ...
                if (drawPos.Y > mPosition.Y && drawPos.Y < mPosition.Y + mPosition.Height - mFrameHorPos2.Height)
                    spritebatch.DrawString(mFont, tl.Text, drawPos, tl.Colour, 0.0f, Vector2.Zero, tl.Scale, SpriteEffects.None, 0.0f);
            }

            spritebatch.Draw(mFrameHor, mFrameHorPos1, null, Color.White, 0.0f, Vector2.Zero, SpriteEffects.FlipVertically, 0.0f);
            spritebatch.Draw(mFrameHor, mFrameHorPos2, null, Color.White, 0.0f, Vector2.Zero, SpriteEffects.FlipVertically, 0.0f);
            spritebatch.Draw(mFrameVer, mFrameVerPos1, null, Color.White, 0.0f, Vector2.Zero, SpriteEffects.FlipVertically, 0.0f);
            spritebatch.Draw(mFrameVer, mFrameVerPos2, null, Color.White, 0.0f, Vector2.Zero, SpriteEffects.FlipVertically | SpriteEffects.FlipHorizontally, 0.0f);
